...
final class WindowToolbarController: NSObject, NSToolbarDelegate {
    private let commandItemIdentifier = NSToolbarItem.Identifier("execuTerm.focusedCommand")
    ...
    private func attach(to window: NSWindow) {
        ...
        let toolbar = NSToolbar(identifier: NSToolbar.Identifier("execuTerm.toolbar"))
